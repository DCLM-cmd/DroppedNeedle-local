...
<a
	...
	onpointerenter={artist.local_id === artist.musicbrainz_id ? undefined : onenrichmentrequest}
	onfocus={artist.local_id === artist.musicbrainz_id ? undefined : onenrichmentrequest}
